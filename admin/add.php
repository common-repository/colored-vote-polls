...
function wpcvp_admin_add_poll() {
	...
	if( isset($_POST['wpcvp_add_submit']) ) {
		...
		$sql = "INSERT INTO ".$table_prefix.WPCVP_POLLS_TABLE." (pollp_title, pollp_desc, pollp_aorder, pollp_unans_color, pollp_status, pollp_expiry, pollp_expiry_date, pollp_adorder, pollp_vresult, pollp_url, pollp_aq, pollp_cat) VALUES ('".$_POST['pollp_title']."', '".$_POST['polldescedit']."', '".$_POST['pollp_aorder']."', '".$_POST['pollp_unans_color']."', '".$_POST['pollp_status']."', '".$expiry."', '".$_POST['pollp_actual_expiry_date']."', '".$_POST['pollp_adorder']."', '".(isset($_POST['pollp_vresult'])?$_POST['pollp_vresult']:'0')."' , '".(isset($_POST['pollp_url'])?$_POST['pollp_url']:'0')."' , '".(isset($_POST['pollp_aq'])?$_POST['pollp_aq']:'0')."' , '".(isset($_POST['pollp_cat'])?$_POST['pollp_cat']:'0')."' )";
		$wpdb->query($sql);
...
<div class="wrap" id="addform">
	...
	<!--<form name="add_poll" id="add_poll" action="<?php echo wpcvp_plugin_url('admin/addSubmit.php');?>" method="post">-->
		...
		<div id="poststuff" class="metabox-holder has-right-sidebar" style="float:right;min-width: 300px;width:28%;"> 
...
" ><?php _e('Developed by Internet Techies','wpcvp'); ?></a></li>
			...
			<div class="postbox"> 
			  <h3 class="hndle"><span></span><?php _e('Search & Compare Themes','wpcvp'); ?></h3> 
			  <div class="inside">
                     <div style="margin:10px auto">
                        <a href="https://purposethemes.com/" title="Search and Compare WordPress Themes" target="_blank"><img src="<?php echo wpcvp_plugin_url('images/purposethemes.png');?>" alt="Search and Compare WordPress Themes" /></a>
...
<div style="float:left;width:70%;">	
	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				<div id="poststuff" style="min-width:300px;max-width: 100%;">
				<?php wp_editor('' ,$id = 'polldescedit', $prev_id = 'title', $media_buttons = false, $tab_index = 2); ?>
				</div>
			</td>
		</tr>
	</tbody></table>
...
<div class="wrap" id="editform">
	<h2><?php _e('Edit Colored Poll - ID '.$pollid,'wpcvp'); ?></h2>
		...
		<div id="poststuff" class="metabox-holder has-right-sidebar" style="float:right;width:28%;min-width:300px;"> 
...
<div style="float:left;width:70%;">	
	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				<div id="poststuff" style="min-width:300px;max-width: 100%;">
				<?php wp_editor( $poll[0]['pollp_desc'] ,$id = 'polldescedit', $prev_id = 'title', $media_buttons = false, $tab_index = 2); ?>
				</div>
			</td>
		</tr>
	</tbody></table>
