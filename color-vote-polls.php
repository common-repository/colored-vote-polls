...
$wpcvp_db_version = "1.1";
$wpcvp_options=get_option('wpcvp_options');
define("WPCVP_VER","1.1",false);//Current Version of Colored Vote Polls plugin
...
//	$content = '';
	//$editor_id = 'cvpeditor';
	//wp_editor( $content, $editor_id ); // true gives you a stripped down version of the editor
}
